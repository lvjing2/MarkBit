...
import com.liwn.zzl.markbit.tools.helper.floodfill.QueueLinearFloodFiller;
...
public class FillCommand extends BaseCommand {
	...
	public void run(Canvas canvas, Bitmap bitmap) {
		...
		if (MarkBitApplication.savedPictureUri == null
				&& MarkBitApplication.commandManager.getNumberOfCommands() == EMPTY_COMMAND_LIST_LENGTH + 1) {
