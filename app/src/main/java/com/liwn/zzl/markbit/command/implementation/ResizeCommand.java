...
public class ResizeCommand extends BaseCommand {
	...
	public void run(Canvas canvas, Bitmap bitmap) {
		...
		if (mFileToStoredBitmap != null) {
			MarkBitApplication.drawingSurface.setBitmap(FileIO
		...
		try {
			...
			if (mResizeCoordinateXLeft == 0
				...
				Log.e(MarkBitApplication.TAG, " no need to resize ");
			...
			if ((mResizeCoordinateXRight + 1 - mResizeCoordinateXLeft)
				...
				Log.e(MarkBitApplication.TAG, " image resolution not supported ");
			...
			MarkBitApplication.drawingSurface.setBitmap(resizedBitmap);
