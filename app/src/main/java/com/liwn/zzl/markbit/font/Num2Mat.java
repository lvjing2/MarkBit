package com.liwn.zzl.markbit.font;// ֻ����95������ʾASCII����
...
public class Num2Mat {
	...
	public void readFromLib() {
		...
		try {
			...
			InputStream inputStream = context.getResources().getAssets().open("fonts/" + "ASC" + String.valueOf(font_height) + "_" + String.valueOf(font_width));
