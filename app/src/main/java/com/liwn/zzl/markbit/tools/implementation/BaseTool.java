...
import com.liwn.zzl.markbit.dialog.BrushPickerDialog.OnBrushChangedListener;
...
import com.liwn.zzl.markbit.dialog.colorpicker.ColorPickerDialog.OnColorPickedListener;
...
public abstract class BaseTool extends Observable implements Tool, Observer {
    // TODO maybe move to MarkBitApplication.
    ...
    static {
        ...
        mBitmapPaint.setStrokeWidth(Tool.stroke1);
        ...
        WindowManager windowManager = (WindowManager) MarkBitApplication.applicationContext
...
//		boolean antiAliasing = (strokeWidth > 1);
    ...
    protected void showBrushPicker() {
        ...
        BrushPickerDialog.getInstance().show(
                ((DrawActivity) mContext).getSupportFragmentManager(),
                "brushpicker");
    }
