...
import com.liwn.zzl.markbit.command.implementation.PathCommand;
import com.liwn.zzl.markbit.command.implementation.PointCommand;
...
public class CursorTool extends BaseToolWithShape {
	...
	public CursorTool(Context context, ToolType toolType) {
		...
		mPrimaryShapeColor = MarkBitApplication.applicationContext
	...
	public boolean handleMove(PointF coordinate) {
		...
		PointF cursorSurfacePosition = MarkBitApplication.perspective
				.getSurfacePointFromCanvasPoint(new PointF(newCursorPositionX,
						newCursorPositionY));

		float surfaceWidth = MarkBitApplication.drawingSurface.getWidth();
		float surfaceHeight = MarkBitApplication.drawingSurface.getHeight();
		...
		if (slowCursor) {
			PointF cursorCanvasPosition = MarkBitApplication.perspective
	...
	protected boolean addPathCommand(PointF coordinate) {
		...
		return MarkBitApplication.commandManager.commitCommand(command);
	}
