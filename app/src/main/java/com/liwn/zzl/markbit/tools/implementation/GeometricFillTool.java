...
import com.liwn.zzl.markbit.command.implementation.StampCommand;
...
public class GeometricFillTool extends BaseToolWithRectangleShape {
	...
	public GeometricFillTool(Context context, ToolType toolType) {
		...
		mColor = new OnColorPickedListener() {
			...
			public void colorChanged(int color) {
				...
				createAndSetBitmap(MarkBitApplication.drawingSurface);
			}
		};
	...
	public void setDrawPaint(Paint paint) {
		// necessary because of timing in DrawActivity and Eraser
...
//		drawPaint.setAntiAlias(DEFAULT_ANTIALISING_ON);
		drawPaint.setAntiAlias(DEFAULT_ANTIALISING_OFF);
