...
public class StampTool extends BaseToolWithRectangleShape {
	...
	private void createAndSetBitmapRotated() {
		...
		Bitmap copyOfCurrentDrawingSurfaceBitmap = MarkBitApplication.drawingSurface
				.getBitmapCopy();
	...
	protected void createAndSetBitmap() {
		...
		Log.d(MarkBitApplication.TAG, "clip bitmap");
		...
		try {
			...
			Log.d(MarkBitApplication.TAG, "created bitmap");
		} catch (Exception e) {
	...
	protected class CreateAndSetBitmapAsyncTask extends
		...
		protected Void doInBackground(Void... arg0) {
			Log.e(MarkBitApplication.TAG, "------------doInBackground");
