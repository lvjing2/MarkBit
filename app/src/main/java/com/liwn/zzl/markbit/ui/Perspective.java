...
public class Perspective implements Serializable {
	...
	private static final float ACTION_BAR_HEIGHT = DrawOptionsMenuActivity.ACTION_BAR_HEIGHT;
	...
	public Perspective(SurfaceHolder holder) {
		...
		mIsFullscreen = false;
		boderZoomFactor = metrics.widthPixels / MarkBitApplication.BIT_LCD_WIDTH;
	}
	...
	public synchronized void resetScaleAndTranslation() {
		...
		mBitmapHeight = MarkBitApplication.drawingSurface.getBitmapHeight();
		mSurfaceScale = 1f;
...
//		float zoomFactor = (mIsFullscreen) ? 1.0f : BORDER_ZOOM_FACTOR;
		float zoomFactor = boderZoomFactor;
